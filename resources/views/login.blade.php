...
<head>
    ...
    <title>Login - Sistem Lisensi Pegawai</title>
                            ...
                            <div class="row">
                                <div class="col-md-4 pe-md-0">
                                    <div class="auth-side-wrapper">
                                        <img src="{{ asset('assets/images/loginwallpaper.jpg') }}" alt=""
                                ...
                                <div class="col-md-8 ps-md-0">
                                    <div class="auth-form-wrapper px-4 py-5">
                                        ...
                                        <form class="forms-sample" action="{{ route('auth') }}" method="POST">
                                            ...
                                            <div>
                                                <button type="submit"
                                                    class="btn btn-primary me-2 mb-2 mb-md-0 text-white">Masuk</button>

                                            </div>
                                            <a href="#" class="d-block mt-3 text-muted">Belum terdaftar?
                                                Silahkan hubungi Admin</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
