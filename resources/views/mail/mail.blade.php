...
<body class="body"
    style="background-color: #e2eace; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
    <table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation"
        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffff;">
        <tbody>
            <tr>
                <td>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-top: 5px; vertical-align: top;">
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    ...
                                                                    <div class="fullWidth" style="max-width: 600px;">
                                                                        <img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/20/rounder-up.png"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
                                                                            width="600" alt="Image" title="Image"
                                                                            height="auto">
                                                                    </div>
                                                                </div>
                                                            </td>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #F8F8F8; color: #000000; width: 600px; margin: 0 auto;"
                                        width="600">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    ...
                                                                    <div style="max-width: 250px;"><img
                                                                            src="https://img.freepik.com/premium-vector/advertising-announcement-new-message-concept-with-notification-bell-icon-vector-illustration_668430-83.jpg"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
                                                                            width="250" alt="Image" title="Image"
                                                                            height="auto">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                ...
                                                <td class="column column-1" width="100%"
                                                    ...
                                                    <table class="paragraph_block block-1" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-size:28px;line-height:120%;text-align:center;mso-line-height-alt:33.6px;">
                                                                    <p style="margin: 0; word-break: break-word;"><span
                                                                            style="word-break: break-word;"><strong><span
                                                                                    style="word-break: break-word;">{{ $title }}</span></strong></span><br><span
                                                    ...
                                                    <table class="paragraph_block block-4" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    style="color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-size:14px;line-height:150%;text-align:center;mso-line-height-alt:21px;">
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"   style="height:62px;width:204px;v-text-anchor:middle;" arcsize="7%" fillcolor="#a8bf6f">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000000; background-color: #525252; width: 600px; margin: 0 auto;"
                                        width="600">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="33.333333333333336%"
                                                    ...
                                                    <table class="social_block block-1" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-top:15px;text-align:center;padding-right:0px;padding-left:0px;">
                                                                <div class="alignment" align="center">
                                                                    <table class="social-table" width="74px"
                                                    ...
                                                    <table class="text_block block-1" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="padding-top:20px;">
                                                                <div style="font-family: sans-serif">
                                                                    <div class
                                                                        style="font-size: 12px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #a8bf6f; line-height: 1.2;">
                                                                        <p
                                                                            style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 14.399999999999999px;">
                                                                            Email <span
                                                                                style="word-break: break-word; color: #ffffff; font-size: 12px;">no-reply@avsecdjalaluddin.my.id</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px">
                                                                    <div class="fullWidth" style="max-width: 600px;">
                                                                        <img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/20/rounder-dwn.png"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
                                                                            width="600" alt="Image"
                                                                            title="Image" height="auto">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
